...
const providerOptions = {
  walletconnect: {
    ...
    options: {
      ...
      rpc: {
        56: "https://mainnet.infura.io/v3/1116a288edfe493e83f178583469195b",
      },
    },
  },
  walletlink: {
    ...
    options: {
      appName: "BitGrow", // Required
      infuraId: "", // Required unless you provide a JSON RPC url; see `rpc` below
      rpc: "https://mainnet.infura.io/v3/1116a288edfe493e83f178583469195b", // Optional if `infuraId` is provided; otherwise it's required
